...
namespace Xunit.AutoGenerated._Y4CPamáif
{
	...
	internal class XunitAutoGeneratedEntryPoint
	{
		public static int Main(string[] args)
		{
			if (global::System.Linq.Enumerable.Any(args, arg => arg == "-automated" || arg == "@@"))
				...
				return global::Xunit.MicrosoftTestingPlatform.TestPlatformTestFramework.RunAsync(args, global::Grimoire.Contract.Tests.SelfRegisteredExtensions.AddSelfRegisteredExtensions).GetAwaiter().GetResult();
		}
	}
}