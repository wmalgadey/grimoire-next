...
The three badges above are regenerated by CI on every push to `main` and read from the `badges` branch. No number is written into this file — only the badge URLs are.
