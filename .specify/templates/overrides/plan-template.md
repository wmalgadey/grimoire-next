...
<!--
  REQUIRED (Constitution I.10). One feature branch off main; each phase of `tasks.md` is a branch
  off the feature branch. Fill this table in BEFORE implementation starts.
-->
