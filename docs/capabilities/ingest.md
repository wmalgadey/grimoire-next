...
A refused submission is the answer to an attempt, not a stored submission: INGEST-003, INGEST-004
and INGEST-005 each say so, and none of RUNS-001's four states has to mean "never ran".
